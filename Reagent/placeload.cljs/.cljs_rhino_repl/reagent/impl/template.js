...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__44909__auto__,writer__44910__auto__,opt__44911__auto__){
return cljs.core._write.call(null,writer__44910__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__48219 = o;
(G__48219[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__48221__i < G__48221__a.length) {G__48221__a[G__48221__i] = arguments[G__48221__i + 0]; ++G__48221__i;}
  args = new cljs.core.IndexedSeq(G__48221__a,0);
} 
...
if(cljs.core.truth_((function (){var and__44291__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__44291__auto__){
var and__44291__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__48228 = jsprops;
(G__48228["defaultValue"] = value);

(G__48228["onChange"] = ((function (G__48228,v,value,on_change){
return (function (p1__48225_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__48225_SHARP_);
});})(G__48228,v,value,on_change))
);

(G__48228["ref"] = ((function (G__48228,v,value,on_change){
return (function (p1__48226_SHARP_){
return (this$["cljsInputElement"] = p1__48226_SHARP_);
});})(G__48228,v,value,on_change))
);
...
var vec__48235 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__48235,(0),null);
var id = cljs.core.nth.call(null,vec__48235,(1),null);
var class$ = cljs.core.nth.call(null,vec__48235,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___48240 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___48240 == null)){
} else {
var key_48241 = temp__4661__auto___48240;
(jsprops["key"] = key_48241);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__48243 = (new reagent.impl.template.NativeWrapper());
(G__48243["name"] = c);
...
var len__45378__auto___48249 = arguments.length;
var i__45379__auto___48250 = (0);
while(true){
if((i__45379__auto___48250 < len__45378__auto___48249)){
args__45385__auto__.push((arguments[i__45379__auto___48250]));

var G__48251 = (i__45379__auto___48250 + (1));
i__45379__auto___48250 = G__48251;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45386__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq48247){
var G__48248 = cljs.core.first.call(null,seq48247);
var seq48247__$1 = cljs.core.next.call(null,seq48247);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__48248,seq48247__$1);
});
...
break;
default:
var G__48255 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__48255;
continue;
...
var n__45218__auto___48258 = a.length;
var i_48259 = (0);
while(true){
if((i_48259 < n__45218__auto___48258)){
(a[i_48259] = reagent.impl.template.as_element.call(null,(a[i_48259])));

var G__48260 = (i_48259 + (1));
i_48259 = G__48260;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__45218__auto___48261 = a.length;
var i_48262 = (0);
while(true){
if((i_48262 < n__45218__auto___48261)){
var val_48263 = (a[i_48262]);
if((cljs.core.vector_QMARK_.call(null,val_48263)) && ((reagent.impl.template.key_from_vec.call(null,val_48263) == null))){
(o["no-key"] = true);
} else {
}

(a[i_48262] = reagent.impl.template.as_element.call(null,val_48263));

var G__48264 = (i_48262 + (1));
i_48262 = G__48264;
continue;
} else {
}
...
var ctx = ({});
var vec__48268 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__48268,(0),null);
var derefed = cljs.core.nth.call(null,vec__48268,(1),null);
...
var G__48272 = (cljs.core.count.call(null,argv) - first_child);
switch (G__48272) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__48272){
